...
export async function embedAssetsInData(data) {
    return (await embedValue(data, new WeakSet()));
}
async function embedValue(value, seen) {
...
//# sourceMappingURL=embedAssets.js.map